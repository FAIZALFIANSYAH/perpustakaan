...
function LostBookModal({ 
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.fines.report-lost', { 
...
export default function Show({ borrowing }: Props) {
    ...
    const submitReturn: FormEventHandler = (event) => {
        ...
        post(route('admin.borrowings.return', borrowing.id));
    };
                                    ...
                                    {borrowing.items.map((item) => {
                                        ...
                                        return (
                                            <tr key={item.id}>
                                                ...
                                                <td className="p-4">
                                                    {remaining > 0 && borrowing.status !== 'returned' && (
                                                        <button
                                        ...
                                        return (
                                            <div key={item.id} className="rounded-xl border border-slate-200 p-4">
                                                ...
                                                <div className="mt-3">
                                                    ...
                                                    />
                                                    {errors[`items.${index}.return_quantity`] && (
                                                        <p className="mt-1 text-sm text-red-600">{errors[`items.${index}.return_quantity`]}</p>
                                                    )}
                                                </div>
                                            </div>
                                        );
